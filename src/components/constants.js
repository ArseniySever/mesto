...
export {page, popupProfile, popupPhoto, popupSubtitle, addButton, popupPlace, editButton, formElementPlace, placesBox, login, job, titleInput, imageInput, formEditProfile, formAddNewCard, nameInput, jobInput};
